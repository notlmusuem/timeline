...
alter table public.timeline
  ...
  -- ensure that end_date == NULL implies end_date_precision == NULL
  add constraint timeline_end_date_precision_null check (end_date is not null or end_date_precision is null);
